...
Manejo de errores:
- validacion_datos: Se encarga de validar que los registros sean los correctos, y lo hace identificando si los tipos de datos son los correctos. Percibe algunos de tipo ValueError y TypeError.
